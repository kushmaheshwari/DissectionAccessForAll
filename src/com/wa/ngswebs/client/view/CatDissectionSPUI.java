...
public class CatDissectionSPUI extends ContentPanel {

	private ContentPanel videoPanel;
	private AbstractImagePrototype image;
	private Label label;

	public CatDissectionSPUI() {
		...
		String text = "<br><center><font color='orange' size='5px'>Cat Dissection Spanish</font></center>";
		text += "<h2>Cat Disection Details here (in Spanish)</h2> ";
