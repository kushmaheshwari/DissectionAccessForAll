...
public class CatDissectionUI extends ContentPanel {

	private ContentPanel videoPanel;
	private AbstractImagePrototype image;
	private Label label;

	public CatDissectionUI() {
		...
		String text = "<br><center><font color='orange' size='5px'>Cat Dissection</font></center>";
		text += "<h2>Cat Disection Details here </h2> ";
		label = new Label();
		label.setText(text);
		add(label);
