...
public class CowEyeDissectionSPUI extends ContentPanel {

	private ContentPanel videoPanel;
	private AbstractImagePrototype image;
	private Label label;

	public CowEyeDissectionSPUI() {
		...
		String text = "<br><center><font color='orange' size='5px'>Cow Eye Dissection Spanish</font></center>";
		text += "<h2>Cow Eye Disection Details here (in Spanish)  </h2> ";
		label = new Label();
		label.setText(text);
		add(label);
